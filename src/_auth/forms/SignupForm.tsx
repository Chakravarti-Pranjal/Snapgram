  ...
  return (
       <Form {...form}>
          <div className="sm:w-420 flex-center flex-col">
            ...
            <p className="text-light-3 small-medium md:base-regular mt-1">To use Snapgram please enter your details</p>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type='text' placeholder="your name here.." className='shad-input' {...field} />
                    </FormControl>
               ...
               {/* for Username field */}
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type='text' placeholder="your username here.." className='shad-input' {...field} />
                    </FormControl>
